...
lnames = load(file = "dataInput_host.Rda");
...
save(sft,file="sft_signed_host.Rda")
...
load("dataInput_host.Rda")
load("sft_signed_host.Rda")
message("data loaded")

softPower = 18; #75 %
adjacency = adjacency(datExpr, power = softPower,type="signed");
#save(adjacency,file="adjacency_host.Rda")
...
save(MEs, moduleLabels, moduleColors, geneTree, file = "networkConstruction-stepByStep_host.Rda")
