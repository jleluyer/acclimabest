...
lnames = load(file = "dataInput_c1_culture.Rda");
#The variable lnames contains the names of loaded variables.
lnames

load("sft_signed_c1_culture.Rda")
message("data loaded")
...
adjacencyCulture = adjacency(datExpr, power = softPower,type="signed");
save(adjacencyCulture,file="adjacency_c1_culture.Rda")
message("done adjency")
#load("adjacency_host.Rda")
TOMCulture = TOMsimilarity(adjacencyCulture,TOMType = "signed");
save(TOMCulture,file="TOM_c1_culture.Rda")
#load("TOM_host.Rda")
...
save(MEsCulture, moduleLabelsCulture, moduleColorsCulture, geneTreeCulture, file = "network_c1_culture.Rda")
